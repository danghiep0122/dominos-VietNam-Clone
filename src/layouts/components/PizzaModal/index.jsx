      ...
      <>
        ...
        <div className={styles.modalWrapper}>
          ...
          <div className={styles.modalContent}>
            ...
            >
              <XtimesIcon height="32px" width="32px" fill="#fff" />
            </button>
            ...
            <div className={styles.modalProductDescrWrapper}>
              ...
              <div className={styles.productDescr}>
                <div className={styles.productDescrSection}>
                  ...
                  <ul>
                    {basePizza.map(({ id, title, describe }) => (
                      <div key={id}>
                        <li>
                          <div>
                            <label>
                              <input
                                className={styles.inputScale}
                                type="radio"
                                name="base"
                                value={id}
                                onChange={(e) => {
                                  setBaseSelected(e.target.value)
                                  setBaseTitleSelected(title)
                                }}
                              />
                              {describe}
                            </label>
                          </div>
                          <div className={styles.productDescrIcon}>
                            <img alt={title} src={images.pizzaBase} />
                          </div>
                        </li>
                        <hr />
                      </div>
                ...
                <div className={styles.productDescrSection}>
                  ...
                  <ul>
                    {sizePizza.map(({ id, price, describe, logo }) => (
                      <div key={id} style={price ? {} : { display: 'none' }}>
                        <li>
                          <div>
                            <label>
                              <input
                                ...
                                onChange={(e) => {
                                  ...
                                  setSizeTitleSelected(describe)
                                }}
                              />
                              {describe} = {formatVND(price)}
                            </label>
                          </div>
                          <div className={styles.productDescrIcon}>
                            <img alt={data.title} src={logo} />
                          </div>
                        </li>
                        <hr />
                      </div>
            ...
            <div className={styles.addToCartSection}>
              <div className={styles.cartItemsQty}>
                <button
                  ...
                  className={itemQty === 1 ? styles.minusButtonDisable : ''}
                >
                  --
                </button>
              ...
              >
                <span style={{ marginRight: '.8rem' }}>Add to Cart</span>
                <span>{formatVND(priceSelected * itemQty)}</span>
              </button>
            </div>
          </div>
        </div>
